...
//
// A tokenizer for list of integers like "{9, 343, 0}".
//
// The are four kinds of tokens: open brace, close braces, commas, and integers.
//
// The tokenizer returns a slice of all the tokens, in the order they occur.
//
// It does *not* care about the order of the tokens, e.g. the tokenizer will
// convert "},, { 349" into a list of tokens.
//
